                ...
                <div class="row center-align noMarginRow">
                    ...
                    <div class="col l3 col m12 col s12">
                        ...
                        <div class="row center-align">
                            <div class="col l6 offset-l3 col m6 offset-m3 col s6 offset-s3">
                                <!--Bouton Accueil-->
                                <a class="waves-effect waves-light modal-trigger linkFooter" href="../index.php">Accueil</a>
                                <!--/Bouton Accueil-->
                            </div>
                        </div>
                        ...
                        <div class="row center-align">
                            <div class="col l6 offset-l3 col m6 offset-m3 col s6 offset-s3">
                                <!--Bouton Contact-->
                                <a class="waves-effect waves-light modal-trigger" id="connectionLink" href="connection-adminPaintins.php">Connexion</a>
                                <!--/Bouton Contact-->
                            </div>
                        </div>
                    </div>
